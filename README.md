...
Note that formatting and symbols are lost when translating into binary. And since we do not have source mapping yet the code you will get back *will* be dense and without any symbols. It is however quite mesmerizing to look at and can be useful for development purpuses such as debugging and comparing different transpilers and/or assemblers.
