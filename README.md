...
Note that formatting and symbols are lost when translating into binary. And since we do not have source mapping yet the code you will get back *will* be dense and without any symbols.
